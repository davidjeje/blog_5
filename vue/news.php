					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li class="has-dropdown active"><a href="index.php?page=news">Blog</a></li>
								<li class="has-dropdown"><a href="index.php?page=inscrip">Inscription</a></li>
				...
				<div class="row">
					...
					?>
						<article class="blog-entry">
							<div class="blog-wrap">
								<span class="category text-center"><a href="blog.html"><h1> <?php echo$n[2]?>  </h1></a></span>
								<h2 class="text-center"><a href="blog.html"><h1> <?php echo$n[3]?>  </h1></a></h2>
								<div class="blog-image">
									<a href="blog.html" class="blog-img text-center" style="background-image: url(<?php echo$n[4]?>);"><span><i class="icon-link"></i></span></a>
									<ul class="share">
								...
								<span class="category text-center"><a href="blog.html"><i class="icon-calendar3"></i> <?php echo$n[0]?>January 21, 2017</a> | <a href="admin.php?id=.". class="posted-by"><i class="icon-user2"></i> <h1> <?php echo$n[1]?>  </h1></a> | <a href="blog.html"><i class="icon-bubble3"></i> 5 Comments</a></span>
							</div>
							<?=
								$nn = $n[0];
							?>
							...
							<p class="text-center"><a href="index.php?page=admin&amp;id=<?=$nn?>" class="btn btn-primary btn-custom">Continue Reading</a><p>
						</article>
					<?php
						}
					...
					<aside class="sidebar">
						...
						<div class="side-wrap">
							...
							<div class="video colorlib-video" style="background-image: url(public/images/blog-1.jpg);">
					...
					<div class="col-md-4">
						...
						<p>
							<ul class="colorlib-footer-links">
                                ...
                                <li><a href="index.php?page=news"><i class="icon-check"></i> Blog</a></li>
                                <li><a href="index.php?page=index"><i class="icon-check"></i> Connexion Administrateur</a></li>
                            </ul>
						</p>
					</div>
